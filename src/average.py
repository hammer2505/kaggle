...
predict_last = (predict_keras * 4 + predict_xgboost * 6) / 10
predict_last1 = (predict_keras * 5 + predict_xgboost * 5) / 10
predict_last2 = (predict_keras * 6 + predict_xgboost * 4) / 10
predict_last3 = (predict_keras * 7 + predict_xgboost * 3) / 10

submission = pd.DataFrame()
submission['id'] = ids
submission['loss'] = predict_last
submission.to_csv('../result/submission_keras_xgboost_45.csv', index=False)
