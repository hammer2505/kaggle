...
df.to_csv('../result/preds_oob_kears.csv', index = False)

## test predictions
pred_test /= (nfolds*nbags)
df = pd.DataFrame({'id': id_test, 'loss': pred_test})
df.to_csv('../result/submission_keras.csv', index = False)
# Keras starter with bagging (LB: 1120.596)
# https://www.kaggle.com/danijelk/allstate-claims-severity/keras-starter-with-bagging-lb-1120-596/comments
